...
class CategorieController extends AbstractController
{
    ...
    /**
     * @Route("/categorie/annonces/{id}", name="categorie_show_annonces", methods={"GET"})
     */
    public function showProducts(AnnonceRepository $annonceRepository, Categorie $categorie): Response
    {

        $annonces = $annonceRepository->findBy(['categorie' => $categorie->getId()]);
        //dd($annonces);
        return $this->render('categorie/Annonces.html.twig', [
            'annonces' => $annonces,
            'categorie' => $categorie,
        ]);
    }
